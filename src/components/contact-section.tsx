...
export const ContactSection = () => {
  ...
  return (
    <section id="contact" className="section bg-secondary/50 dark:bg-secondary/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-1 space-y-8">
            <div className="fade-in-section">
              <div className="flex items-start">
                <div className="w-12 h-12 rounded-full bg-highlight/20 flex items-center justify-center mr-4 shrink-0">
                  <Mail className="text-highlight" />
                </div>
                <div>
                  <h3 className="text-lg font-medium mb-1">Email</h3>
                  <p className="text-muted-foreground">hello@johndoe.com</p>
                  <a href="mailto:hello@johndoe.com" className="text-highlight hover:underline">
                    Send an email
                  </a>
                </div>
              </div>
            ...
            <div className="fade-in-section">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+15551234567" className="text-highlight hover:underline">
                    Give me a call
                  </a>
                </div>
              </div>
          ...
          <div className="md:col-span-2 fade-in-section">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button 
                type="submit" 
                className="w-full md:w-auto bg-highlight hover:bg-highlight/80"
